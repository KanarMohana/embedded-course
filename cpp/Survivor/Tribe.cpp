...
bool Tribe::set_name(string _name)
{
    delete[] name;
...
bool Tribe::addSurvivor(string name, int age, Survivor::eStatus status, Bandana& band)
{
...
void Tribe::initialize_Tribe(string _name, int _max)
{
    set_name(_name);
