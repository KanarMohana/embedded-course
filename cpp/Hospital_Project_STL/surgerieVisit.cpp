...
surgerieVisit::surgerieVisit(const string& visit_date,  patient *patientPtr, const string& visit_purbose, department* dep,employee* res_emp , int numSurgerieRoom,bool isFasting) : visit(visit_date, patientPtr, visit_purbose, dep, res_emp)
{
