...
patient::patient(const char* person_name, const char* person_id,const int year, const char *gender):person(person_name,person_id), visit_logical_size(0), visit_physical_size(2)
{
    this->year = year;
    this->gender = new char[strlen(gender) + 1];
    strcpy(this->gender, gender);
...
ostream &operator<<(ostream &os, const patient &p)
{
    ...
    os << "Gender: " << p.gender << "\n";
    os << "Visits Deatils : \n";
    os << "logical size " << p.visit_logical_size <<endl;
